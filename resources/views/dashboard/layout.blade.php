            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Fullstack Developer
                            with Laravel 10.X</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Laravel
                            Portofolio</span>
                    </div>
                </footer>
                <!-- partial -->
